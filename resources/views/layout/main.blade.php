        ...
        <aside :class="sidebarOpen ? 'w-72' : 'w-24'"
            ...
            <nav class="flex-grow px-4 py-6 space-y-2 overflow-y-auto">
                <a href="#"
                    ...
                    <span x-show="sidebarOpen" class="ml-4 font-medium">Dashboard</span>
                </a>
                ...
                <div x-data="{ open: false }">
                    <button @click="open = !open"
                        ...
                        <div class="flex items-center">
                            ...
                            <span x-show="sidebarOpen" class="ml-4 font-medium">Akademik</span>
                        </div>
                    ...
                    <div x-show="open && sidebarOpen" x-transition:enter="transition ease-out duration-200"
                        ...
                        x-transition:enter-end="opacity-100 translate-y-0" class="mt-2 ml-10 space-y-1">
                        <a href="#" class="block px-4 py-2 text-sm text-blue-200 hover:text-white transition">Data
                            Guru</a>
                        <a href="#" class="block px-4 py-2 text-sm text-blue-200 hover:text-white transition">Data
                            Murid</a>
                        <a href="#" class="block px-4 py-2 text-sm text-blue-200 hover:text-white transition">Data
                ...
                <div x-data="{ open: false }">
                    <button @click="open = !open"
                        ...
                        <div class="flex items-center">
                            <i data-lucide="database"
                                class="w-5 h-5 text-blue-300 group-hover:text-white transition"></i>
                            <span x-show="sidebarOpen" class="ml-4 font-medium">Manajemen</span>
                        </div>
                        <i x-show="sidebarOpen" data-lucide="chevron-down"
                            class="w-4 h-4 transition-transform duration-300" :class="open ? 'rotate-180' : ''"></i>
                    </button>
                    ...
                    <div x-show="open && sidebarOpen" x-transition class="mt-2 ml-10 space-y-1">
                        <a href="#" class="block px-4 py-2 text-sm text-blue-200 hover:text-white transition">Mata
                            Pelajaran</a>
                        <a href="#"
                            class="block px-4 py-2 text-sm text-blue-200 hover:text-white transition">Jadwal
                            Pelajaran</a>
                        <a href="#"
                            class="block px-4 py-2 text-sm text-blue-200 hover:text-white transition">Kurikulum</a>
                    </div>
                </div>

                <a href="#"
                    class="flex items-center px-4 py-3 rounded-xl text-blue-100 hover:bg-white/5 transition-all group">
                    <i data-lucide="file-bar-chart" class="w-5 h-5 text-blue-300 group-hover:text-white transition"></i>
                    <span x-show="sidebarOpen" class="ml-4 font-medium">Laporan Nilai</span>
                </a>
            </nav>
